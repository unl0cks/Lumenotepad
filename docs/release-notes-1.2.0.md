<!-- summary: Updates install from inside the app now, so macOS only asks you to approve Lumenotepad once. Installing is a drag-and-drop, keyboard shortcuts work, and the window behaves in full screen. -->
